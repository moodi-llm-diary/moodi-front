...
| POST `/auth/google-credentials` | GIS redirect form `credential`, `g_csrf_token`, `state` | `303` allow-listed returnTo + session cookie | 401 Google credential/attempt, 403 CSRF, 409 consumed attempt, 429 |
